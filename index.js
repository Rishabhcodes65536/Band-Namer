...
var myAudio = new Audic("./sounds/beep.mp3");
const app = express();
const port = 3000;
...
function playSound(){
  ...
  const audio = new Audio(__dirname+ "/sounds/guitar.mp3");
  audio.play();
  next();
}
...
app.post("/submit", (req, res) => {
  // myAudio.play();
  console.log('playsound!!!!');
  const sizeAdjective=adjective.length;
  const sizeNoun=noun.length;
  var randAdjective=adjective[Math.floor(sizeAdjective*Math.random())];
  var randNoun=noun[Math.floor(sizeNoun*Math.random())];
  res.render("index.ejs",{
